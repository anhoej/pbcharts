...
`pbcharts` implements the I prime (I' or normalised I) control chart suggested by Taylor (2017) <https://variation.com/normalized-individuals-control-chart/>. The I' chart adjusts the control limits to varying subgroup sizes making `pbcharts` useful for a wide range of measurement and count data and a convenient replacement for the classic Shewhart control charts.
